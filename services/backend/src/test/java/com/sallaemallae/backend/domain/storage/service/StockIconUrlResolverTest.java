...
class StockIconUrlResolverTest {
    ...
    private StockIconUrlResolver resolver(String publicUrl, String bucket) {
        return new StockIconUrlResolver(publicUrl, bucket);
    }

    @Test
    @DisplayName("상대 경로를 전체 URL로 변환한다")
    void resolve_relativePath() {
        StockIconUrlResolver resolver = resolver("https://cdn.example.com", "assets");
    ...
    void resolve_trailingSlash() {
        ...
        assertThat(resolver.resolve("stock-icons/test.png"))
            .isEqualTo("https://cdn.example.com/assets/stock-icons/test.png");
    }
