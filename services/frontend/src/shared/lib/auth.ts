...
const authErrorMessages: Record<string, string> = {
  ...
  STORAGE_001: "프로필 이미지 업로드 준비에 실패했습니다. 잠시 후 다시 시도해 주세요.",
  STORAGE_002: "프로필 이미지는 JPG, PNG, GIF, WEBP 형식만 업로드할 수 있습니다.",
  STORAGE_003: "프로필 이미지는 5MB 이하만 업로드할 수 있습니다.",
  STORAGE_004: "업로드한 프로필 이미지를 확인하지 못했습니다. 다시 시도해 주세요.",
