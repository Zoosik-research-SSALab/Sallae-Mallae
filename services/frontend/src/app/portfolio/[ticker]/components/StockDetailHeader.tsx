  ...
  return (
    <div className="flex flex-col justify-between gap-6 px-3 py-6 md:flex-row md:items-center md:border-b md:border-border-primary">
      ...
      <div className="flex items-center justify-end gap-2 mt-3 md:mt-0">
        <button
          type="button"
          className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold bg-bg-info-subtle text-text-info transition-opacity hover:opacity-80"
        >
          <IoHeart size={16} />
          관심종목
        </button>
        <button
          type="button"
          className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold bg-bg-tertiary text-text-secondary transition-opacity hover:opacity-80"
        >
