            ...
            {isLoading ? (
              ...
              items.map((item) => (
                <motion.article
                  ...
                  className="rounded-xl border-b border-[color:var(--color-border-secondary)] px-4 py-3 transition-colors hover:bg-[color:var(--color-bg-secondary)] focus-within:bg-[color:var(--color-bg-secondary)]"
                >
                  <div className="flex items-center justify-between gap-4 rounded-xl px-2 py-1">
                    <Link
                      href={`/stocks/${item.id}`}
                      className="flex min-w-0 flex-1 items-center gap-4 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-border-interactive-primary)]"
                    >
