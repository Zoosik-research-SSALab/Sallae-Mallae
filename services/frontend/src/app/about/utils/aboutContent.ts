...
export const AGENTS: AboutAgent[] = [
  {
    ...
    mobileDescriptionLines: ["기업의 재무제표,", "매출 성장성, 산업의", "미래 가치를 분석하여", "본질적인 매력도를", "평가합니다."],
  ...
  },
  {
    ...
    mobileDescriptionLines: ["과거의 주가 패턴, 거래량,", "이동평균선을 계산하여 최적의", "매수·매도 타이밍을", "포착합니다."],
  ...
  },
  {
    ...
    mobileDescriptionLines: ["뉴스 헤드라인, 투자자", "포럼, SNS 반응을", "자연어 처리(NLP)로", "분석해 시장의 공포와", "탐욕 지수를 읽어냅니다."],
